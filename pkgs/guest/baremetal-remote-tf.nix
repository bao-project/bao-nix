...
stdenv.mkDerivation rec {
    ...
    unpackPhase = ''
        ...
        cp -r ${setup-cfg.bao-tests}/* $out/tests/bao-tests
        cp -r ${setup-cfg.tests_srcs}/* $out/tests/src
    ...
    installPhase = ''
        mkdir -p $out/bin
        cp ./build/${setup-cfg.platform_name}/baremetal.bin $out/bin/${guest_name}.bin
    '';
