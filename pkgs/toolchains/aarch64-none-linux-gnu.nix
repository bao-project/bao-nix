...
stdenv.mkDerivation rec {
  pname = "aarch64-none-linux-elf";
  version = "13.2.rel1";
  platform = "x86_64";

  src = fetchurl {
    url = "https://developer.arm.com/-/media/Files/downloads/gnu/${version}/binrel/arm-gnu-toolchain-${version}-${platform}-aarch64-none-linux-gnu.tar.xz";
