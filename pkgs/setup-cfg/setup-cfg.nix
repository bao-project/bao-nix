...
let
    ...
    platforms-linux-toolchain = {
        qemu-aarch64-virt = "aarch64-none-linux-gnu";
        zcu102 = "aarch64-none-linux-gnu";
        zcu104 = "aarch64-none-linux-gnu";
        imx8qm = "aarch64-none-linux-gnu";
        tx2 = "aarch64-none-linux-gnu";
        rpi4 = "aarch64-none-linux-gnu";
        fvp-a = "aarch64-none-linux-gnu";
        fvp-r = "aarch64-none-linux-gnu";
        fvp-a-aarch32 = "arm-none-eabi";
        fvp-r-aarch32 = "arm-none-eabi";
        qemu-riscv64-virt = "riscv64-unknown-linux-gnu";
    };
...
in {
    ...
    linux_toolchain_name = platforms-linux-toolchain.${platform};
    bao-tests = bao-tests;
